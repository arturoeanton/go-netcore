...
[GoShim("bytes.Reader")]
public sealed class GoReader { public byte[] Data = System.Array.Empty<byte>(); public int Pos; public int PrevRune = -1; public string? GzName, GzComment; public string? SrcPath; /* set when the reader drains a real file (os.Open), for Stat */ }
...
public static class Readers
{
    ...
    internal static byte[] Drain(object? r)
    {
        switch (r)
        {
            ...
            case GoTarReader tr: return Tar.DrainEntry(tr);
