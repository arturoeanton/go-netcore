...
## 4. Stdlib overlay (C# shim mechanism live; 145 conformance fixtures byte-exact; P0 hardened, P1+P2+P3 partial)
...
| 145 conformance fixtures (000–135), all byte-exact vs `go run` | ✅ | M | ✅ |
