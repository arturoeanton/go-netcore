...
## 4. Stdlib overlay (C# shim mechanism live; 146 conformance fixtures byte-exact; P0 hardened, P1+P2+P3 partial)
...
| 146 conformance fixtures (000–135), all byte-exact vs `go run` | ✅ | M | ✅ |
